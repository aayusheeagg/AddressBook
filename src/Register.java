...
public class Register extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String LoginId1= jTextField2.getText();
        String Passwd1= new String(jPasswordField1.getPassword());
        boolean b= DBManager.registeruser(UserName1, LoginId1, Passwd1);
        if(b)
        {
            ...
            JOptionPane.showMessageDialog(this, "LoginId already exists");
            reset();
        }       
